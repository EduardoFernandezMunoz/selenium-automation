...
- **test_alerts_and_windows.py**  
  Handling new windows/tabs, JavaScript alerts and confirm boxes

- **test_frames.py**  
  iFrames interactions and input validations inside frames

- **test_shop_flow.py**  
  End-to-end purchase flow:
  product selection, checkout process, dynamic waits and success validation
